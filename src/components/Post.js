...
export default function Post() {
    return (
        <div className="flex justify-left bg-white rounded-xl max-w-2xl mt-8 mx-auto p-8 shadow-lg">
            <div className="">
                <img src={photo} alt="propic" className="h-10 rounded-full ring-2 ring-basic" />
            </div>
            <div className="ml-4">
                <div className="">
                ...
                <div className="flex gap-3 pt-4">
                    <div className="flex cursor-pointer hover:bg-gray-100 px-3 py-1 rounded-lg">
