...
export default function Register() {
  ...
  return (
    <div className="flex items-center justify-center  h-screen bg-white">
     ...
     <div className=" relative max-w-2/5 lg:object-left xl:w-2/5 h-7/12 ">
  
  <h1 className="text-4xl sm:text-5xl  fond-semibold text-black ml-5 pt-5">Get started with your account </h1>
