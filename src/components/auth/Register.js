	...
	return (
		<div className="flex justify-center h-screen max-h-full min-h-full pr-12 pl-12 md:pr-0 md:pl-0 w-full md:max-w-full mx-auto bg-white rounded-xl shadow-lg">
			<div className="hidden h-32 md:h-auto md:w-3/4 md:block lg:block">
				<img src={SignUp} alt="LoginPage" className="object-contain md:object-scale-down h-full w-full" />
			</div>
			...
			<div className="flex flex-col justify-center md:pr-28 md:pl-10 lg:pr-32">
				...
				<div className="">
					<p className="text-gray-500 text-xs mt-6 italic text-center">
						...
						<span className="pl-2 text-basic font-semibold cursor-pointer">Terms,</span>
						<span className="pl-2 pr-1 text-basic font-semibold cursor-pointer">Privacy Policy</span> and
						<span className="pl-2 text-basic font-semibold cursor-pointer">Content Policy.</span>
					</p>
				</div>
			</div>
		</div>
